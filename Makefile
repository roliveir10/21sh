...
$(NAME): $(OBJ_PATH) $(OBJ) $(OBJ_LEX) $(OBJ_LINE) $(OBJ_SIG) $(OBJ_BUILT)
	@make -C libft
	@$(CC) $(CFLAGS) -o $(NAME) -I $(INC_PATH) -ltermcap -I $(LIB_INC_PATH) $(LIBFT_FLAG) -o $(NAME) $(OBJ) $(OBJ_LEX) $(OBJ_LINE) $(OBJ_SIG) $(OBJ_BUILT)
...
clean:
	@make clean -C libft
	@/bin/rm -f $(OBJ) $(OBJ_LEX) $(OBJ_LINE) $(OBJ_SIG) $(OBJ_BUILT)
	@rm -rf $(OBJ_PATH) 2>&-
